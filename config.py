...
argument_config = {
    'consumer_key': os.getenv('CONSUMER_KEY', 'FqVuU3N3s31Rfi1vXdbPolrJ4'),
    'consumer_secret': os.getenv('CONSUMER_SECRET', 'bvH9tLYGWf5zNyXTRN8qTRg8lns0P8nvyhYHzc8MLpIeQtxtBs'),
    ...
    'kafka_broker_uri': os.getenv('KAFKA_BROKER_URI', '40.71.214.191:9092'),
